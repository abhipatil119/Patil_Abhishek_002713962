 ...
 */
public class PetClaim_1 extends javax.swing.JFrame {
    ...
    try {
            ...
            Logger.getLogger(PetClaim_1.class.getName()).log(Level.SEVERE, null, ex);
...
//                sp.patient_reg(pd);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pst1 = conn.prepareStatement("SELECT base_premium,pet_dog, pet_cat, female, male, age_0_6_months, age_6_12_months, age_1_3_years, age_3_5_years, age_5_7_years, age_7_9_years,age_9plus_years,company from PetPricing");
...
//                sp.patient_reg(pd);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PetClaim_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PetClaim_1().setVisible(true);
            }
        });
    }
