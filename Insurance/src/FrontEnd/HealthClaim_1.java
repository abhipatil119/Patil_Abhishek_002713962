 ...
 */
public class HealthClaim_1 extends javax.swing.JFrame {
...
//                sp.patient_reg(pd);
            ...
            Logger.getLogger(HealthClaim_1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    DefaultTableModel health = (DefaultTableModel) healthtable.getModel();
        ...
        String sales_id = health.getValueAt(healthtable.getSelectedRow(), 11).toString();
         ...
         JdbcConnection jdbc = new JdbcConnection();
            ...
            int k = pst.executeUpdate();
            if (k==1){
                JOptionPane.showMessageDialog(this, "Policy Subscribed!!!");
...
//                sp.patient_reg(pd);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HealthClaim_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HealthClaim_1().setVisible(true);
            }
        });
    }
